                              ...
                              <form  method="POST" action="{{$url}}" enctype="multipart/form-data">
                                ...
                                <br />
                                  ...
                                  <div class="form-group">
          													...
          													<div class="col-md-8">
          														<input type="text" class="form-control" name="name" value="{{ old('name')}}" placeholder="ข้อความต้อนรับ">
          														</div>
          												</div>
                                  ...
                                  <div class="form-group">
          													...
          													<div class="col-md-8">
          														<input type="text" class="form-control" name="url" value="{{ old('url')}}" placeholder="www.google.com">
          														</div>
          												</div>
                                  ...
                                  <div class="form-group">
          													...
          													<div class="col-md-8">
          														<input type="text" class="form-control" name="timer" value="{{ old('timer')}}" placeholder="1000">
                                  ...
                                  <div class="form-group">
          													...
          													<div class="col-md-8">
          														<input type="number" class="form-control" name="num_sort" value="{{ old('num_sort')}}" placeholder="1">
          														</div>
          												</div>
