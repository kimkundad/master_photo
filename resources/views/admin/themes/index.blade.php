              ...
              <div class="panel-body">
                ...
                <div class="col-md-12 " style="padding-left: 1px;">
                  ...
                  <a class="btn btn-primary " href="{{url('admin/themes/create')}}" >
                      <i class="fa fa-plus"></i> เพิ่ม Themes</a>
                </div>
                <br><br>
                      ...
                      <td>
                        ...
                        <div class="btn-group flex-wrap">
  												...
  												<div class="dropdown-menu" role="menu">
  													...
  													<a class="dropdown-item text-1" href="{{url('admin/themes/'.$u->id_c.'/edit')}}">แก้ไข</a>

                          <form  action="{{url('admin/themes/'.$u->id_c)}}" method="post" onsubmit="return(confirm('Do you want Delete'))">
