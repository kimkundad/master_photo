                        ...
                        <div class="col-md-8 col-lg-8">
                          ...
                          <div class="wizard-progress wizard-progress-lg">
                            ...
                            @endif
                              ...
                              <a href="{{url('admin/taopix/'.$get_data->id.'/edit')}}" class="btn btn-primary">กลับไปยังข้อมูลหลัก</a>
                              <br />
                                ...
                                <hr />
                                  ...
                                  <div class="form-group">
                                    ...
                                    <div class="col-md-8">
                                        ...
                                        <option value="{{$item_2->id_d}}"
                                          @if( $item_2->id_d == $exp[$s])
                                          selected='selected'
                                          @endif
                                          >{{$item_2->item_name}}</option>
                                        @endforeach
                                      </select>
                                      </select>
                                    </div>
