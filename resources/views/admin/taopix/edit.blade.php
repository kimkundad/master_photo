                        ...
                        <div class="col-md-8 col-lg-8">
                          ...
                          <div class="wizard-progress wizard-progress-lg">
                            ...
                            <ul class="nav wizard-steps">
                              ...
                              <li class="nav-item active completed">
                                <a class="nav-link"  href="{{url('admin/edit_taopix_theme/'.$objs->id_q)}}"><span>2</span>ธีม</a>
                              </li>
                              <li class="nav-item active completed">
                                <a class="nav-link" href="{{url('admin/edit_taopix_option/'.$objs->id_q)}}"><span>3</span>ออฟชั่น</a>
                              </li>
                            ...
                            <form  method="POST" action="{{$url}}" enctype="multipart/form-data">
                                ...
                                <hr />
                                  ...
                                  <div class="form-group">
                                    ...
                                    <div class="col-md-8">
                                      <input type="text" class="form-control" name="taopix_name" value="{{ $objs->taopix_name }}">
                                      </div>
                                  </div>
                                    ...
                                    <div class="col-md-8">
                                        ...
                                        <option value="">-- เลือกสินค้า --</option>
                                          @foreach($product as $u)
                                             <option value="{{$u->id}}" @if( $objs->pro_id == $u->id)
                                             selected='selected'
                                             @endif
                                             >{{$u->pro_name}}</option>
                                          @endforeach
                                  ...
                                  <div class="form-group">
                                    ...
                                    <div class="col-md-8">
                                      <input type="text" class="form-control" name="url_taopix" value="{{ $objs->url_taopix }}">
                                      </div>
                                  </div>
