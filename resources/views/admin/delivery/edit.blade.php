    ...
    margin-top: -20px;
        ...
        <section role="main" class="content-body">
          ...
          <div class="row">
                        ...
                        <div class="col-md-8 col-lg-8">
                              ...
                              <form  method="POST" action="{{$url}}" enctype="multipart/form-data">
                                  ...
                                  <div class="form-group">
          													<label class="col-md-3 control-label" for="profileFirstName">ชื่อบริการู่*</label>
          													<div class="col-md-8">
                        ...
                        @if($objs->id == 8 || $objs->id == 9 || $objs->id == 13)
                        <div class="tabs">
                              ...
                              <div class="modal" id="modalBootstrap" tabindex="-1" role="dialog">
                                    ...
                                    <form  method="POST" action="{{url('admin/add_deli_item')}}" enctype="multipart/form-data">
                                        ...
                                        <input type="hidden" class="form-control" name="de_status" value="{{$objs->id}}">
