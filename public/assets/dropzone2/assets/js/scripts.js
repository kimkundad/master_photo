...
!function ($) {
	...
	Onyx = {
		...
		userFilesDropzone: {
	        ...
	        $("#next_to_cart2").removeClass('hidden');
				...
				onyxDropzone.on("success", function(file, response) {
					...
					setTimeout(function(){
						...
						$(".uploaded-files-count2").html(base.dropzoneCount2());
						console.log('Files count: ' + base.dropzoneCount2());

						if(base.dropzoneCount() == base.dropzoneCount2()){
							setTimeout(function() {
			            window.location.href = "../photo_edit/"+parsedResponse.file_link;
			        }, 1800);
						}
					/*	setTimeout(function() {
	            window.location.href = "{{url('photo_edit')}}/"+parsedResponse.file_link;
	        }, 1800); */
			...
			dropzoneCount2: function() {
				var filesCount2 = $("#previews > .dz-image-preview").length;
				return filesCount2;
			},
